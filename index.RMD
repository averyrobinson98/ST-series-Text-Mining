...
Another aspect of interest is Dustin's placements of first for most total lines, yet fifth for median number of words per line. These dual placements suggest he is a frequent, but short, speaker, which is relevant in considering Dustin is the character with the highest number of "sh\*t"s in the series.
